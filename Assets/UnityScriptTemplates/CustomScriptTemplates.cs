...
namespace UnityScriptTemplates {
    ...
    public static class CustomScriptTemplates {
        ...
        private static string TemplatePathScriptableObject {
            get { return Application.dataPath + "/EditorDefaultResources/ScriptTemplates/ScriptableObjectTemplate.cs.txt"; }
        }
        ...
        private static string TemplatePathPlainClass {
            get { return Application.dataPath + "/EditorDefaultResources/ScriptTemplates/PlainClassTemplate.cs.txt"; }
        }
